...
const deleteFruitStorageByName = new DeleteFruitStorageByName(
	fruitRepository,
	storageRepository,
	unitOfWork,
);
const deleteFruitStorageByNameController = new DeleteFruitStorageByNameController(
	deleteFruitStorageByName,
);
