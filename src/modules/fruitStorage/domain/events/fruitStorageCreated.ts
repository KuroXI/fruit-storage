...
export const FRUIT_STORAGE_CREATE_EVENT_NAME = "FRUIT_STORAGE_CREATE";

export class FruitStorageCreated implements IDomainEvent<FruitStorage> {
	...
	constructor(payload: FruitStorage) {
		this._eventName = FRUIT_STORAGE_CREATE_EVENT_NAME;
